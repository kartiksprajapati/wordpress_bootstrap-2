...
function blankslate_child_speakup_setup()
{
	 ...
	 */
	load_theme_textdomain('blankslate_child_speakup', get_template_directory() . '/languages');
...
{
	// wp_enqueue_style('blankslate_child_speakup-style', get_stylesheet_uri(), array(), _S_VERSION);
	wp_enqueue_style('blankslate_child_speakup-main', get_template_directory_uri() . '/css/main.css', array(), _S_VERSION);
	wp_enqueue_style('blankslate_child_speakup-fontawesome', get_template_directory_uri() . '/css/fontawesome/css/all.css', array(), _S_VERSION);

	wp_style_add_data('blankslate_child_speakup-style', 'rtl', 'replace');

	wp_enqueue_script('blankslate_child_speakup-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true);
	wp_enqueue_script('blankslate_child_speakup-main', get_template_directory_uri() . '/js/main.js', array(), _S_VERSION, true);
	wp_enqueue_script('blankslate_child_speakup-bootstrap', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js', array(), _S_VERSION, true);
